    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            width: 80, height: 80,
            decoration: BoxDecoration(shape: BoxShape.circle, color: color.withOpacity(0.2), border: Border.all(color: color)),
          ...
          const Text('Tempo'),
          Slider(value: tempo, min: 0.8, max: 1.2, divisions: 20, label: '${(tempo*128).toInt()} BPM', onChanged: onTempo),
